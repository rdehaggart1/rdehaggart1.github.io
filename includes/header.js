...
document.write("document.getElementsByClassName(\"navButton\").item(0).style.marginLeft = \"25%\";");
document.write("}");
document.write("else");
document.write("{");
document.write("sideNav.style.width = \"0\";");
document.write("main.style.marginLeft = \"10%\";");
document.write("document.getElementsByClassName(\"navButton\").item(0).style.marginLeft = \"10%\";");
document.write("}");
document.write("}");
document.write("}");
document.write("</script>");